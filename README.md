...
<br/>
4. Number of Instances: There are a total of 8000 instances (rows) in the dataset.
<br/>
5. Number of Attributes: The dataset initially consists of 20 attributes (columns). After removing redundant columns, there are 17 attributes remaining.
6. <br/>
